...
for forbidden_runtime_override in HPC_CONTAINER_RUNTIME_ROOT HPC_CONTAINER_FORWARD_PREFIXES HPC_PROJECT_ROOT_SOURCE HPC_CONTAINER_NO_MOUNT SOURCE_FIELD_MANIFEST_FILE; do
