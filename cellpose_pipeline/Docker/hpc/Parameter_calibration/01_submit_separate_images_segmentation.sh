...
DENSITY_WORKER="$PROJECT_DIR/cellpose_pipeline/Docker/hpc/Parameter_calibration/03_run_density_prepass.sh"
...
sbatch "${SBATCH_ARGS[@]}" \
  "$PROJECT_DIR/cellpose_pipeline/Docker/hpc/Parameter_calibration/02_run_separate_images_array_task.sh" \
