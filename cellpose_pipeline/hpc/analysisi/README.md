...
- `06_run_dose_response_analysis.sh` consumes those tables and atomically
  rebuilds the complete 82-file AUC, Day-4, Day-5, GR, and excess-lethal-
  fraction output tree.
...
- `08_submit_classification_reports_backfill.sh` submits the calibration
  ...
  `classification_20260723_101944` production result and the frozen
  `late_dead_trajectory_optimization_20260723_024151` calibration.
