...
CALIBRATION_ROOT="${CALIBRATION_ROOT:-$BASE/results/Tests_and_Parameters_calibration/death_classification_uncertainty_optimization_20260728_170922/retry6}"
...
write_submission_summary() {
  {
    ...
    echo "death_refinement_method_version=death_classification_consensus_v3_low_uncertainty_20260728"
