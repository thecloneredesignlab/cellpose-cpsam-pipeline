...
SCREEN_WORKER="$PROJECT_DIR/cellpose_pipeline/hpc/Parameter_calibration/21_run_high_density_bf_combined_screen.sh"
SCORE_WORKER="$PROJECT_DIR/cellpose_pipeline/hpc/Parameter_calibration/22_run_high_density_bf_combined_score.sh"
QC_WORKER="$PROJECT_DIR/cellpose_pipeline/hpc/Parameter_calibration/23_run_high_density_bf_combined_qc.sh"
...
SCREEN_OUTPUT="$(
  sbatch "${SCREEN_SBATCH_ARGS[@]}" "$SCREEN_WORKER"
)"
echo "$SCREEN_OUTPUT"
