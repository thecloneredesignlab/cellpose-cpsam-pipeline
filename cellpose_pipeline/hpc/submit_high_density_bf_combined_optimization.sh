...
SCREEN_WORKER="$PROJECT_DIR/cellpose_pipeline/hpc/run_high_density_bf_combined_screen.sh"
SCORE_WORKER="$PROJECT_DIR/cellpose_pipeline/hpc/run_high_density_bf_combined_score.sh"
QC_WORKER="$PROJECT_DIR/cellpose_pipeline/hpc/run_high_density_bf_combined_qc.sh"
