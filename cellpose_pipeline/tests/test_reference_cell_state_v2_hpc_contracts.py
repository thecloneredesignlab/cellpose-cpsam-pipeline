...
class ReferenceCellStateV2HpcContracts(unittest.TestCase):
    def test_expanded_calibration_is_direct_blind_latest_sif_and_test_root_only(self) -> None:
        ...
        for required in (
            ...
            "33_build_reference_cell_state_seed1_review.R",
            "37_render_reference_cell_state_exact_review.py",
            "shape9,classifier12,expanded39",
            "expanded_features_allowed_in_final_classifier\\tfalse",
            "--expanded-labelability-decision",
            "EXPANDED_GUIDED_BLIND_REVIEW_COMPLETE.tsv",
            "render_guided_v1",
            "blind_review_workspace=",
            "must contain exactly 500 rows",
            "observed_max_per_well",
