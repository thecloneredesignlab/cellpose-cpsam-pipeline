"""Dataset-adapted multimodal features for the independent V3 cell-state axis.

The module consumes Brightfield-derived measurements plus Nuclei raw/mask
evidence.  It deliberately has no API for Dead images, current classifier
outputs, or trajectory data.
"""
...
FEATURE_SCHEMA_VERSION = "multimodal_cell_state_v3_features_v1"
SHAPE_COLUMNS = (
    "area_px2",
    "roundness",
    "aspect_ratio",
...
OUTPUT_FEATURE_COLUMNS = SHAPE_COLUMNS + BRIGHTFIELD_COLUMNS + NUCLEI_COLUMNS + NUCLEI_QC_COLUMNS
