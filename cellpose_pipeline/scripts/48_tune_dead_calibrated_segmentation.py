...
workflow = load_module("cellpose_workflow18", SCRIPT_DIR / "18_run_segmentation_classification_workflow.py")
blue_tune = load_module("combined_blue_tune46", SCRIPT_DIR / "46_tune_combined_blue_segmentation.py")
