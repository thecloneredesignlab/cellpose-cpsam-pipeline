...
workflow = load_module("cellpose_workflow01_consensus", SCRIPT_DIR / "01_segment_images.py")
blue_utils = load_module(
    "combined_blue_segmentation_utils_consensus",
    SCRIPT_DIR / "_shared" / "combined_blue_segmentation_utils.py",
)
