...
UTILS_PATH = Path(__file__).resolve().parent / "_shared" / "nuclei_segmentation_utils.py"
...
def write_rows(
    ...
    with temporary.open("w", newline="") as handle:
        writer = csv.DictWriter(handle, fieldnames=resolved_fields, extrasaction="raise")
        writer.writeheader()
